...
import com.vikas.userprofile.ui.loginScreen
import com.vikas.userprofile.ui.theme.UserProfileTheme
            ...
            UserProfileTheme {
                ...
                Surface {
                    NavHost(navController = navcontroller, startDestination = "login_screen") {
                        composable("login_screen") { loginScreen(launcherLoginFlow = ::launchLoginFlow, navController = navcontroller)}
                        composable("edit_screen") { editScreen(navcontroller, mainViewModel) }
                        composable("user_profile") { userProfile(navcontroller, mainViewModel) }
                        composable("ChatScreen") { chatScreen(mainViewModel) }
                    }
                }
            }
        }
